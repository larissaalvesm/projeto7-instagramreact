...
export default function Posts() {
    ...
    const dadosPosts = [
        ...
        { imagemUsuario: "assets/img/meowed.svg", nomeUsuario: "meowed", imagemPost: "assets/img/gato-telefone.svg", nomePost: "gato-no-telefone", imagemCurtida: "assets/img/respondeai.svg", nomeCurtida: "respondeai" }
